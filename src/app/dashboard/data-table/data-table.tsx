...
export function DataTable<TData, TValue>({
  ...
  return (
    <div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            {table
              ...
              .filter((column) => column.id !== "actions") // Con esto evitamos mostrar la columna de acciones
              .map((column) => {
                return (
                  <DropdownMenuCheckboxItem
                    key={column.id}
      ...
      <Select
        onValueChange={(value) => table.setPageSize(Number(+value))} // Aquí se cambia el tamaño de la página
      >
